...
class CouponRvAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CouponRvAdapter.ViewHolder {
        val binding =
    ...
    override fun onBindViewHolder(holder: CouponRvAdapter.ViewHolder, position: Int) {
